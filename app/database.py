...
#         """Initialize SQLite database with in-memory storage"""
#         self.db_name = db
...
#         """Store a receipt in SQLite and return its ID"""
#         receipt_id = generate_receipt_id()
        
#         # Convert receipt to dict and store as JSON
...
#                 (receipt_id, json.dumps(receipt_data))
#             )
#             conn.commit()
